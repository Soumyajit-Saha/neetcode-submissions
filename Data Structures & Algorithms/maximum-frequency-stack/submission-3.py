class FreqStack:
    ...
    # For popping, get the list with max count as key, pop the last element, and decrement its count
    # If the max count entry in stacks gets empty, decrement the max count
    def __init__(self):
        self.stacks = {}
        self.count = {}
        self.maxCount = 0
